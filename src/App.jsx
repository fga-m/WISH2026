...
// Map Technical Slot IDs to human-friendly Spreadsheet Headers
...
const WORKSHOPS_DATA = [
  ...
  { id: 'w2', title: 'Adulting 101', speaker: 'Mike and Maggie', category: 'Youth/ Young Adult', biography: 'Mike is an engineer and business owner. Maggie is a healthcare professional and homemaker.', description: "Honest conversation about the skills that actually matter in your 20s: finances, career, self care, life admin." },
  { id: 'w3', title: 'Entrepreneurship', speaker: 'Aaron Lau / Michael Ting', category: 'Career', biography: "Mike and Aaron have started half a dozen businesses between them.", description: "Entrepreneurship isn't just about starting a business. It's a posture, a way of seeing the world and responding to what doesn't exist yet." },
  { id: 'w4', title: 'Crossing borders, changing jobs', speaker: 'Alan Wong', category: 'Career', biography: 'Alan has worked across Asia-Pacific as an investment banker and fund manager.', description: 'Trusting God’s sovereignty in life’s desert seasons and career transitions.' },
  { id: 'w5', title: 'Engaging AI', speaker: 'Alan Wong and Lawrence Chen', category: 'Tech', biography: 'Lawrence is a data analyst. Alan is a father and ex-entrepreneur with a passion for new tech.', description: 'Explore what AI is (and isn’t) and how it can be used wisely and practically in daily life.' },
  { id: 'w6', title: 'Crowded House', speaker: 'Ash and Grace Chan', category: 'Family', biography: 'Married for seven years and parents of two, Ash and Grace live in a village of five adults.', description: 'Living with three generations offers incredible support but unique challenges.' },
  { id: 'w7', title: 'Study Hacks', speaker: 'Ashley Ng', category: 'Youth', biography: 'Ashley completed 8 VCE subjects and a Bachelor of Commerce. She has tutored for 5 years.', description: 'Practical strategies for studying more effectively and avoiding last-minute cramming.' },
  { id: 'w8', title: 'Women Dating', speaker: 'Belle Seow / Grace Leong', category: 'Relationships', biography: 'Belle and Grace bring insights from their own dating journeys.', description: 'Grounding yourself in God’s truth so you don’t lose yourself in the process of dating.' },
  { id: 'w9', title: 'Demons in Christians?', speaker: 'Charles Ho', category: 'Theology', biography: 'Leaders of the Shalom Ministry (Inner Healing and Deliverance).', description: 'Recognizing demonic oppression and practical steps toward freedom.' },
  { id: 'w10', title: 'Sex in the Suburbs', speaker: 'Daniel and Julie Wong', category: 'Marriage', biography: "Married for 37 years with 4 children and 4 grandchildren.", description: 'Discussing the joys of marital sex and the barriers couples face in intimacy.' },
  { id: 'w11', title: 'Running', speaker: 'David Gunn, Michelle Tsiros and Dennis Wong', category: 'Health', biography: 'Passionate runners who believe in physical, mental, and spiritual health benefits.', description: 'A workshop for anyone who has ever thought about getting into running.' },
  { id: 'w12', title: 'Gut & Brain', speaker: 'Dr. Dennis Wong', category: 'Health', biography: 'Medical doctor with a strong interest in brain health.', description: 'How what we eat shapes how we think, feel, and age.' },
  { id: 'w13', title: 'Menopause Questions', speaker: 'Dr. Sze Wey Lee', category: 'Health', biography: 'Obstetrician and gynaecologist with 20 years of experience.', description: 'Myths about menopause and the pros and cons of management.' },
  { id: 'w14', title: 'Life Vision Board', speaker: 'Elaine Choi', category: 'Personal Growth', biography: 'Trainer with a heart for guiding women through seasons of transition.', description: 'Aligning your life with God’s purpose rather than personal pressure.' },
  { id: 'w15', title: 'Know Your WHY', speaker: 'Elijah Seow', category: 'Purpose', biography: 'Following Christ for 12 years with a heart for transparency.', description: 'Identifying core motivations to avoid exhaustion and burnout.' },
  { id: 'w16', title: 'Men Dating', speaker: 'Elijah Seow / Daniel Ong', category: 'Relationships', biography: 'Newly married and engaged young men sharing their journeys.', description: 'Navigating dating today by sharing perspectives, mistakes, and learnings.' },
  { id: 'w17', title: 'Beyond Possible', speaker: 'Evelyn Seow', category: 'Theology', biography: 'Four decades of ministry experience.', description: 'Biblical steps to walk in the miraculous.' },
  { id: 'w18', title: 'Homeschool Life', speaker: 'Ewnice Teh (and Tim)', category: 'Parenting', biography: 'Married for 15 years, raising three children.', description: 'Why they chose to homeschool and how it allowed their family to reclaim time.' },
  { id: 'w19', title: 'Meet Meat', speaker: 'Jean-Paul Seow', category: 'Cooking', biography: 'Meat enthusiast.', description: 'Learn about different cuts, seasoning, and restaurant-quality tricks.' },
  { id: 'w20', title: 'Motorhome Life', speaker: 'Jit Lim', category: 'Lifestyle', biography: 'Traveled Australia in a motorhome.', description: 'Experiences from three winters on the road.' },
  { id: 'w21', title: 'Unexpected Life', speaker: 'Josh So and Mel Cheung', category: 'Testimony', biography: 'Josh and Mel call FGAM home.', description: 'Exploring how God works through seasons of waiting and uncertainty.' },
  { id: 'w22', title: 'Creative Dance', speaker: 'Kim Teh', category: 'Arts', biography: 'Dance choreographer and teacher.', description: 'Discovering the hidden dancer for God through movement as prayer.' },
  { id: 'w23', title: 'Teen Mental Health', speaker: 'Marie Yap (OAM)', category: 'Parenting', biography: 'Professor of Psychology specializing in adolescent mental health.', description: 'Practical and spiritual strategies to support teenagers.' },
  { id: 'w24', title: 'Parenting Expectations', speaker: 'May Yen Ong', category: 'Parenting', biography: 'Served in ministry for over 20 years.', description: 'Navigate changing expectations as children grow into teens.' },
  { id: 'w25', title: 'God’s Will', speaker: 'Michael Ting / Stephanie Lok', category: 'Youth', biography: 'Active leaders living the question of God\'s will.', description: 'Discernment guideposts through lived experience.' },
  { id: 'w26', title: 'Simple Cooking', speaker: 'Min Leong Ong', category: 'Cooking', biography: 'Home cooking specialist.', description: 'A food demonstration focused on effortless cooking.' },
  { id: 'w27', title: 'Domestic Violence', speaker: 'Mona Julien', category: 'Care', biography: 'Advocate with 20+ years experience.', description: 'Community talk about hidden domestic violence and supportive responses.' },
  { id: 'w28', title: 'Sanctification and Success', speaker: 'Nevile Waterman', category: 'Leadership', biography: 'Business leader with experience in church and corporate life.', description: 'Grow in faith and character while following Christ in a complex world.' },
  { id: 'w29', title: 'Grief & Loss', speaker: 'Ps. Andrew Harper', category: 'Care', biography: 'Hospital chaplain for 11 years.', description: 'Encountering God in the midst of painful seasons of grief.' },
  { id: 'w30', title: 'Advanced Bible Study', speaker: 'Ps. Andrew Harper', category: 'Theology', biography: 'Pastoral leader since 1987.', description: 'Deep dive into scriptural study.' },
  { id: 'w31', title: "Following God's Calling", speaker: 'Ps. Roland Seow', category: 'Testimony', biography: 'Founding Pastor of FGA Melbourne.', description: "Chronicling FGAM's formation story and discerning God's voice." },
  { id: 'w32', title: 'Healing Parental Hurt', speaker: 'Sarah Man and Lai Hing', category: 'Family', biography: 'Sarah is a counsellor and Lai Hing is a social worker.', description: 'Testimony on modeled humility to address and repair relational hurts.' },
  { id: 'w33', title: 'Spirit-Led Parenting', speaker: 'Sonja Loke', category: 'Parenting', biography: 'Kids Pastor at FGA Kids.', description: 'Inviting the Holy Spirit to transform how you respond to children.' },
  { id: 'w34', title: 'Financial Freedom', speaker: 'Wally Chiang', category: 'Finance', biography: 'Wally retired at 41 after reaching financial independence.', description: 'Biblical framework for financial stewardship.' },
  { id: 'w35', title: 'Missions Topic', speaker: 'Chai Ng', category: 'Missions', biography: 'TBC', description: 'Exploring the heart of God for missions.' },
  { id: 'w36', title: 'Family Activity', speaker: 'Harold Nguyen', category: 'Family', biography: 'TBC', description: 'Fun stage activity designed for all families.' },
  { id: 'w37', title: 'Grow in Worship', speaker: 'Iain Low', category: 'Worship', biography: 'TBC', description: 'How a life of worship contributes to spiritual growth.' },
  { id: 'w38', title: 'Living with Disability', speaker: 'Ivan Low', category: 'Lifestyle', biography: 'TBC', description: 'Testimony about disability and how God walks with you.' },
  { id: 'w39', title: 'Counselling Options', speaker: 'Matt Jones', category: 'Care', biography: 'Matt Jones is Head of Crossway LifeCare.', description: 'When to refer to professional care and how to give confidence to care.' },
  { id: 'w40', title: 'Apologetics', speaker: 'Peggy Ong', category: 'Theology', biography: 'TBC', description: 'Defending your faith from Bible scholar Aunty Peggy.' },
  { id: 'w41', title: 'Steps for Staying Faithful', speaker: 'Peggy Ong', category: 'Faith', biography: 'TBC', description: 'Practical steps for staying faithful as a Christian.' },
  { id: 'w42', title: 'No Burnouts', speaker: 'Albert Lee', category: 'Leadership', biography: 'Seasoned commercial executive.', description: 'The art of leading better without consuming yourself.' },
  { id: 'w43', title: 'Decision Fatigue', speaker: 'Ps. Chris Ong', category: 'Leadership', biography: 'TBC', description: 'Why decision fatigue is common and how to approach choices wisely.' },
  { id: 'w44', title: "Things We Don't Talk About in the Journey", speaker: 'Ps. Chris Ong', category: 'Testimony', biography: 'TBC', description: 'Honest reflections on the hidden costs and trials of the journey.' },
  { id: 'w45', title: 'Honesty', speaker: 'Ps. Isaac Ling', category: 'Faith', biography: 'TBC', description: 'How to live an honest, transparent God-honoring life.' },
  { id: 'w46', title: 'Spiritual Ministry', speaker: 'Ps. Isaac Ling', category: 'Ministry', biography: 'TBC', description: 'Time of spiritual ministry with Ps. Isaac Ling.' },
  { id: 'w47', title: 'Older Fitness', speaker: 'Tim Tan', category: 'Health', biography: 'Chiropractor.', description: 'Honour God with your body as a temple. Beginner-friendly exercises.' },
  { id: 'w48', title: 'Youth are Leaders Today', speaker: 'JP / Jordan', category: 'Youth', biography: 'TBC', description: 'Sharing how young people are learning to live out their faith now.' },
  { id: 'w49', title: 'My Faith, My Journey', speaker: 'TBC', category: 'Youth', biography: 'TBC', description: 'Biblical testimony and everyday faithfulness for youth.' },
  { id: 'w50', title: 'Live It Out!', speaker: 'TBC', category: 'Youth', biography: 'TBC', description: 'Panel discussion equipping youth to see how actions reflect Christ.' },
  { id: 'w51', title: 'Family Stage Activity', speaker: 'TBC', category: 'Family', biography: 'TBC', description: 'Engagement for the whole family.' },
  { id: 'w52', title: 'Youth Presentation Activity', speaker: 'TBC', category: 'Youth', biography: 'TBC', description: 'Group presentation workshop.' },
  { id: 'w53', title: 'Designing A Youth Service', speaker: 'TBC', category: 'Youth', biography: 'TBC', description: 'Next-gen faith and vibrancy in worship.' },
];
      ...
      <main className="flex-1 flex flex-col relative text-balance">
        {selectedWorkshopId ? (
          ...
          <div className="max-w-2xl w-full mx-auto p-6 pb-32">
                        ...
                        return (
                          <div key={`personal-ev-${event.id}`} className="flex gap-4 items-start">
                            ...
                            >
                              ...
                              <div className="flex items-center gap-1.5 mt-3 text-xs text-gray-500 font-semibold uppercase tracking-wider"><MapPin size={13} /> {event.location || (workshop ? 'Multiple Rooms' : 'TBA')}</div>
                            </div>
                          </div>
                        );
                      })}
            ...
            {activeTab === 'workshops' && (
              <div className="animate-in fade-in duration-500 space-y-10">
                <div className="text-left"><h2 className="text-4xl font-extrabold text-[#ED4E23] font-serif">Workshops</h2><p className="text-sm text-gray-500 font-medium mt-1 text-left">Browse and search for specific sessions.</p></div>
                ...
                <div className="grid grid-cols-1 gap-4 text-left">
                  {filteredWorkshops.map((w) => (
                    <div key={`w-list-${w.id}`} onClick={() => setSelectedWorkshopId(w.id)} className="bg-white p-6 rounded-[2rem] shadow-sm border border-transparent hover:border-[#E8BA21]/30 hover:shadow-md cursor-pointer active:scale-[0.99] transition-all group flex flex-col gap-1"><h3 className="font-extrabold text-xl text-gray-900 leading-tight group-hover:text-[#4563AD] transition-colors">{w.title}</h3><p className="text-[#ED4E23] text-sm font-bold uppercase tracking-wider">{w.speaker}</p>{w.category && <p className="text-[#4563AD] text-[10px] font-extrabold uppercase tracking-widest bg-[#4563AD]/5 inline-block px-2.5 py-1 rounded-full self-start mt-2 border border-[#4563AD]/10">{w.category}</p>}</div>
                  ))}
